...
public class AncientAltarRecipe extends ProcessRecipe {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(this.inputs.get(0), offsets.getX(), offsets.slot() + TextureUtils.SLOT.size()).backgroundTexture(TextureUtils.WIDGETS, 0, 0);
        widgets.addSlot(this.inputs.get(6), offsets.getX(), offsets.slot() - TextureUtils.SLOT.size()).backgroundTexture(TextureUtils.WIDGETS, 0, 0);
        offsets.x().addSlot(false);
        widgets.addSlot(this.inputs.get(1), offsets.getX(), offsets.slot() + TextureUtils.SLOT.size() * 2).backgroundTexture(TextureUtils.WIDGETS, 0, 0);
        widgets.addSlot(this.inputs.get(4), offsets.getX(), offsets.slot()).backgroundTexture(TextureUtils.WIDGETS, 18, 0);
        widgets.addSlot(this.inputs.get(7), offsets.getX(), offsets.slot() - TextureUtils.SLOT.size() * 2).backgroundTexture(TextureUtils.WIDGETS, 0, 0);
        offsets.x().addSlot(false);
        widgets.addSlot(this.inputs.get(2), offsets.getX(), offsets.slot() + TextureUtils.SLOT.size()).backgroundTexture(TextureUtils.WIDGETS, 0, 0);
        widgets.addSlot(this.inputs.get(8), offsets.getX(), offsets.slot() - TextureUtils.SLOT.size()).backgroundTexture(TextureUtils.WIDGETS, 0, 0);
        offsets.x().addSlot(false);
